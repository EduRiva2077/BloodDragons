...
export class CombatService {
  ...
  constructor() {
    ...
    { 
      ...
      abilities: [
        { id: 'a1', name: 'Varredura com Espada Longa', type: 'action', category: 'weapon', range: 1.5, areaShape: 'cone', angle: 90, damage: '1d8+3', damageType: 'slashing', description: 'Uma ampla varredura com uma espada longa.', attackBonus: 5 },
    ...
    { 
      ...
      sheet: { class: 'Mago', level: 3, background: 'Sábio', playerName: 'Jogador 2', race: 'Elfo', alignment: 'Caótico e Bom', xp: 900, hitDie: 6, str: 8, dex: 14, con: 12, int: 16, wis: 13, cha: 10, ac: 12, initiative: 2, speed: 9, proficiencyBonus: 2, passivePerception: 11, hp: 22, maxHp: 22, spellUses: 3, maxSpellUses: 3 },
      abilities: [
    ...
    { 
      ...
      abilities: [
        { id: 'a4', name: 'Fenda Goblin', type: 'action', category: 'weapon', range: 1.5, areaShape: 'circle', radius: 1.5, damage: '2d6+2', damageType: 'slashing', description: 'Um ataque giratório selvagem atingindo todos por perto.', attackBonus: 4 }
      ]
    },
    { id: 't4', name: 'Lacaio Goblin', x: 9, y: 4, hp: 7, maxHp: 7, spellUses: 0, maxSpellUses: 0, conditions: [], controlledBy: 'user_gm_1', color: '#22c55e', type: 'enemy', abilities: [{ id: 'a5', name: 'Cimitarra', type: 'action', category: 'weapon', range: 1.5, damage: '1d6+2', damageType: 'slashing', description: 'Ataque corpo-a-corpo.', attackBonus: 4 }], sheet: { class: 'Lacaio', level: 1, background: 'Monstro', playerName: 'Mestre', race: 'Goblin', alignment: 'Neutro e Mau', xp: 50, hitDie: 6, str: 8, dex: 14, con: 10, int: 10, wis: 8, cha: 8, ac: 13, initiative: 2, speed: 9, proficiencyBonus: 2, passivePerception: 9, hp: 7, maxHp: 7, spellUses: 0, maxSpellUses: 0 } },
    { id: 't5', name: 'Lacaio Goblin', x: 7, y: 4, hp: 7, maxHp: 7, spellUses: 0, maxSpellUses: 0, conditions: [], controlledBy: 'user_gm_1', color: '#22c55e', type: 'enemy', abilities: [{ id: 'a6', name: 'Cimitarra', type: 'action', category: 'weapon', range: 1.5, damage: '1d6+2', damageType: 'slashing', description: 'Ataque corpo-a-corpo.', attackBonus: 4 }], sheet: { class: 'Lacaio', level: 1, background: 'Monstro', playerName: 'Mestre', race: 'Goblin', alignment: 'Neutro e Mau', xp: 50, hitDie: 6, str: 8, dex: 14, con: 10, int: 10, wis: 8, cha: 8, ac: 13, initiative: 2, speed: 9, proficiencyBonus: 2, passivePerception: 9, hp: 7, maxHp: 7, spellUses: 0, maxSpellUses: 0 } },
    ]);
  }
